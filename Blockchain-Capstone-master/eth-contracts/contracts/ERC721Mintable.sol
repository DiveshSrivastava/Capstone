...
contract ERC721 is Pausable, ERC165 {
    ...
    public 
    {
        ...
        require(to == ownerOf(tokenId), "Can't Approve Self");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "Caller is not authorized for this token");
    ...
    internal 
    {
        require(ownerOf(tokenId) == from, "Only token owner can Transfer");
        require(to != address(0), "Invalid to address");
